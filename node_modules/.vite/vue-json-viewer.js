import {
  require_vue
} from "./chunk-UTY7HSBV.js";
import "./chunk-IR4ARIAJ.js";
import {
  __commonJS
...
var require_vue_json_viewer = __commonJS({
  "node_modules/vue-json-viewer/vue-json-viewer.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module == "object" ? module.exports = t(require_vue(), require_clipboard()) : typeof define == "function" && define.amd ? define(["vue", "clipboard"], t) : typeof exports == "object" ? exports.JsonView = t(require_vue(), require_clipboard()) : e.JsonView = t(e.vue, e.clipboard);
      ...
      return a = {}, r.m = i = [function(e, t, n2) {
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", { value: true });
        var r2 = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(e2) {
          return typeof e2;
        } : function(e2) {
        ...
        t.default = { name: "JsonBox", inject: ["expandDepth", "onKeyclick"], props: { value: { type: [Object, Array, String, Number, Boolean, Function, Date], default: null }, keyName: { type: String, default: "" }, sort: Boolean, depth: { type: Number, default: 0 }, previewMode: Boolean, forceExpand: Boolean, showArrayIndex: Boolean, showDoubleQuotes: Boolean, path: { type: String, default: "$" } }, data: function() {
          ...
          this.value === null || this.value === void 0 ? n3 = s.default : Array.isArray(this.value) ? n3 = d.default : Object.prototype.toString.call(this.value) === "[object Date]" ? n3 = p.default : r2(this.value) === "object" ? n3 = c.default : typeof this.value == "number" ? n3 = u.default : typeof this.value == "string" ? n3 = a2.default : typeof this.value == "boolean" ? n3 = l.default : typeof this.value == "function" && (n3 = f.default);
          var o3 = this.keyName && this.value && (Array.isArray(this.value) || r2(this.value) === "object" && Object.prototype.toString.call(this.value) !== "[object Date]");
        ...
        t.default = { name: "JsonUndefined", functional: true, props: { jsonValue: { type: Object, default: null } }, render: function() {
          return (0, o2.h)("span", { class: { "jv-item": true, "jv-undefined": true }, innerText: this.jsonValue === null ? "null" : "undefined" });
        } };
      }, function(e, t, n2) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: true });
        ...
        t.default = { name: "JsonArray", props: { jsonValue: { type: Array, required: true }, keyName: { type: String, default: "" }, depth: { type: Number, default: 0 }, sort: Boolean, expand: Boolean, forceExpand: Boolean, previewMode: Boolean, showArrayIndex: Boolean, showDoubleQuotes: Boolean, path: String }, data: function() {
          ...
          var t2 = this, n3 = 1 < arguments.length && arguments[1] !== void 0 ? arguments[1] : 0;
          n3 === 0 && (this.value = []), setTimeout(function() {
        ...
        var o2, r2, i2, u = {}, l = (o2 = function() {
          ...
          return r2 = r2 === void 0 ? o2.apply(this, arguments) : r2;
        }), a2 = (i2 = {}, function(e2) {
          if (i2[e2] === void 0) {
            var t2 = function(e3) {
        ...
        function b(e2) {
          e2.parentNode !== null && (e2.parentNode.removeChild(e2), 0 <= (e2 = d.indexOf(e2)) && d.splice(e2, 1));
        }
        function j(e2) {
        ...
        function y(t2, e2) {
          ...
          return r3 = e2.singleton ? (a3 = c++, n3 = s = s || j(e2), o3 = w.bind(null, n3, a3, false), w.bind(null, n3, a3, true)) : t2.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (i3 = e2, a3 = document.createElement("link"), i3.attrs.type = "text/css", i3.attrs.rel = "stylesheet", g(a3, i3.attrs), h(i3, a3), n3 = a3, o3 = function(e3, t3, n4) {
            var o4 = n4.css, r4 = n4.sourceMap, n4 = t3.convertToAbsoluteUrls === void 0 && r4;
        ...
        e.exports = function(e2, a3) {
          ...
          (a3 = a3 || {}).attrs = typeof a3.attrs == "object" ? a3.attrs : {}, a3.singleton || typeof a3.singleton == "boolean" || (a3.singleton = l()), a3.insertInto || (a3.insertInto = "head"), a3.insertAt || (a3.insertAt = "bottom");
          var s2 = v(e2, a3);
        ...
        e.exports = function(e2) {
          ...
          return e2.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(e3, t3) {
            ...
            return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/)/i.test(t3) ? e3 : (t3 = t3.indexOf("//") === 0 ? t3 : t3.indexOf("/") === 0 ? n2 + t3 : o2 + t3.replace(/^\.\//, ""), "url(" + JSON.stringify(t3) + ")");
          });
        };
      }, function(e, t) {
        e.exports = o;
        ...
        e.exports = function(e2, t2) {
          return t2 = t2 || {}, typeof (e2 = e2 && e2.__esModule ? e2.default : e2) != "string" ? e2 : (/^['"].*['"]$/.test(e2) && (e2 = e2.slice(1, -1)), t2.hash && (e2 += t2.hash), /["'() \t\n]/.test(e2) || t2.needQuotes ? '"'.concat(e2.replace(/"/g, '\\"').replace(/\n/g, "\\n"), '"') : e2);
        };
      }, function(e, t) {
        ...
        if (r.r(n2), Object.defineProperty(n2, "default", { enumerable: true, value: t }), 2 & e && typeof t != "string")
          for (var o2 in t)
...
// dep:vue-json-viewer
var vue_json_viewer_default = require_vue_json_viewer();
export {
  vue_json_viewer_default as default
};
/*!
